...
public class History_Humidity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_humidity);
        ...
        lineChart = findViewById(R.id.Hline);
        showChart(lineChart);
        getHumData();
    }
    ...
    private void getHumData(){
        netWorkBusiness.getSensorData(deviceID, "humidity", "6", "30", "2021-09-10 00:00:00",
