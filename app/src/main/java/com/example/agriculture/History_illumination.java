...
public class History_illumination extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_illumination);
        ...
        lineChart = findViewById(R.id.Iline);
        showChart(lineChart);
        getillData();
    }
    //设置图表显示样式
    ...
    private void getillData(){
        netWorkBusiness.getSensorData(deviceID, "illuminance", "6", "30", "2021-09-10 00:00:00",
